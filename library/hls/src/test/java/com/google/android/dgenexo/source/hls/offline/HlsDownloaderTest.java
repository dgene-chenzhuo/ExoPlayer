 ...
 */
package com.google.android.dgenexo.source.hls.offline;

import static com.google.android.dgenexo.source.hls.offline.HlsDownloadTestData.ENC_MEDIA_PLAYLIST_DATA;
import static com.google.android.dgenexo.source.hls.offline.HlsDownloadTestData.ENC_MEDIA_PLAYLIST_URI;
import static com.google.android.dgenexo.source.hls.offline.HlsDownloadTestData.MASTER_MEDIA_PLAYLIST_1_INDEX;
import static com.google.android.dgenexo.source.hls.offline.HlsDownloadTestData.MASTER_MEDIA_PLAYLIST_2_INDEX;
import static com.google.android.dgenexo.source.hls.offline.HlsDownloadTestData.MASTER_PLAYLIST_DATA;
import static com.google.android.dgenexo.source.hls.offline.HlsDownloadTestData.MASTER_PLAYLIST_URI;
import static com.google.android.dgenexo.source.hls.offline.HlsDownloadTestData.MEDIA_PLAYLIST_0_DIR;
import static com.google.android.dgenexo.source.hls.offline.HlsDownloadTestData.MEDIA_PLAYLIST_0_URI;
import static com.google.android.dgenexo.source.hls.offline.HlsDownloadTestData.MEDIA_PLAYLIST_1_DIR;
import static com.google.android.dgenexo.source.hls.offline.HlsDownloadTestData.MEDIA_PLAYLIST_1_URI;
import static com.google.android.dgenexo.source.hls.offline.HlsDownloadTestData.MEDIA_PLAYLIST_2_DIR;
import static com.google.android.dgenexo.source.hls.offline.HlsDownloadTestData.MEDIA_PLAYLIST_2_URI;
import static com.google.android.dgenexo.source.hls.offline.HlsDownloadTestData.MEDIA_PLAYLIST_3_DIR;
import static com.google.android.dgenexo.source.hls.offline.HlsDownloadTestData.MEDIA_PLAYLIST_3_URI;
import static com.google.android.dgenexo.source.hls.offline.HlsDownloadTestData.MEDIA_PLAYLIST_DATA;
import static com.google.android.dgenexo.testutil.CacheAsserts.assertCacheEmpty;
import static com.google.android.dgenexo.testutil.CacheAsserts.assertCachedData;
import static com.google.common.truth.Truth.assertThat;

import android.net.Uri;
import androidx.test.core.app.ApplicationProvider;
import androidx.test.ext.junit.runners.AndroidJUnit4;
import com.google.android.dgenexo.offline.DefaultDownloaderFactory;
import com.google.android.dgenexo.offline.DownloadRequest;
import com.google.android.dgenexo.offline.Downloader;
import com.google.android.dgenexo.offline.DownloaderConstructorHelper;
import com.google.android.dgenexo.offline.DownloaderFactory;
import com.google.android.dgenexo.offline.StreamKey;
import com.google.android.dgenexo.source.hls.playlist.HlsMasterPlaylist;
import com.google.android.dgenexo.testutil.CacheAsserts.RequestSet;
import com.google.android.dgenexo.testutil.FakeDataSet;
import com.google.android.dgenexo.testutil.FakeDataSource.Factory;
import com.google.android.dgenexo.upstream.DummyDataSource;
import com.google.android.dgenexo.upstream.cache.Cache;
import com.google.android.dgenexo.upstream.cache.NoOpCacheEvictor;
import com.google.android.dgenexo.upstream.cache.SimpleCache;
