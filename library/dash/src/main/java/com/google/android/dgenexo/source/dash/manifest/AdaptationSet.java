...
public class AdaptationSet {
  ...
  /**
   * The type of the adaptation set. One of the {@link com.google.android.dgenexo.C}
   ...
   * @param type The type of the adaptation set. One of the {@link com.google.android.dgenexo.C}
   *     {@code TRACK_TYPE_*} constants.
