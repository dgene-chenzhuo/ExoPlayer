...
public final class ExoPlayerLibraryInfo {
  ...
  /**
   * Whether the library was compiled with {@link com.google.android.dgenexo.util.Assertions}
   * checks enabled.
   */
  ...
  /**
   * Whether the library was compiled with {@link com.google.android.dgenexo.util.TraceUtil}
   * trace enabled.
   */
