...
import com.google.android.dgenexo.audio.AudioCapabilities;
import com.google.android.dgenexo.audio.AudioProcessor;
import com.google.android.dgenexo.audio.AudioRendererEventListener;
import com.google.android.dgenexo.audio.DefaultAudioSink;
import com.google.android.dgenexo.audio.MediaCodecAudioRenderer;
import com.google.android.dgenexo.drm.DrmSessionManager;
import com.google.android.dgenexo.drm.FrameworkMediaCrypto;
import com.google.android.dgenexo.mediacodec.MediaCodecSelector;
import com.google.android.dgenexo.metadata.MetadataOutput;
import com.google.android.dgenexo.metadata.MetadataRenderer;
import com.google.android.dgenexo.text.TextOutput;
import com.google.android.dgenexo.text.TextRenderer;
import com.google.android.dgenexo.trackselection.TrackSelector;
import com.google.android.dgenexo.util.Log;
import com.google.android.dgenexo.video.MediaCodecVideoRenderer;
import com.google.android.dgenexo.video.VideoRendererEventListener;
import com.google.android.dgenexo.video.spherical.CameraMotionRenderer;
...
public class DefaultRenderersFactory implements RenderersFactory {
  ...
  protected void buildVideoRenderers(
    ...
    try {
      ...
      // LINT.IfChange
      Class<?> clazz = Class.forName("com.google.android.dgenexo.ext.vp9.LibvpxVideoRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              long.class,
              android.os.Handler.class,
              com.google.android.dgenexo.video.VideoRendererEventListener.class,
              int.class);
    ...
    try {
      // Full class names used for constructor args so the LINT rule triggers if any of them move.
      // LINT.IfChange
      Class<?> clazz = Class.forName("com.google.android.dgenexo.ext.av1.Libgav1VideoRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              long.class,
              android.os.Handler.class,
  ...
  protected void buildAudioRenderers(
    ...
    try {
      // Full class names used for constructor args so the LINT rule triggers if any of them move.
      // LINT.IfChange
      Class<?> clazz = Class.forName("com.google.android.dgenexo.ext.opus.LibopusAudioRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              android.os.Handler.class,
              com.google.android.dgenexo.audio.AudioRendererEventListener.class,
              com.google.android.dgenexo.audio.AudioProcessor[].class);
      // LINT.ThenChange(../../../../../../../proguard-rules.txt)
      Renderer renderer =
    ...
    try {
      // Full class names used for constructor args so the LINT rule triggers if any of them move.
      // LINT.IfChange
      Class<?> clazz = Class.forName("com.google.android.dgenexo.ext.flac.LibflacAudioRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              android.os.Handler.class,
              com.google.android.dgenexo.audio.AudioRendererEventListener.class,
    ...
    try {
      ...
      // LINT.IfChange
      Class<?> clazz =
          Class.forName("com.google.android.dgenexo.ext.ffmpeg.FfmpegAudioRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              android.os.Handler.class,
              com.google.android.dgenexo.audio.AudioRendererEventListener.class,
