 ...
 */
package com.google.android.dgenexo.extractor;

import com.google.android.dgenexo.extractor.amr.AmrExtractor;
import com.google.android.dgenexo.extractor.flac.FlacExtractor;
import com.google.android.dgenexo.extractor.flv.FlvExtractor;
...
import com.google.android.dgenexo.extractor.mp4.Mp4Extractor;
import com.google.android.dgenexo.extractor.ogg.OggExtractor;
import com.google.android.dgenexo.extractor.ts.Ac3Extractor;
import com.google.android.dgenexo.extractor.ts.Ac4Extractor;
import com.google.android.dgenexo.extractor.ts.AdtsExtractor;
import com.google.android.dgenexo.extractor.ts.DefaultTsPayloadReaderFactory;
import com.google.android.dgenexo.extractor.ts.PsExtractor;
import com.google.android.dgenexo.extractor.ts.TsExtractor;
import com.google.android.dgenexo.extractor.ts.TsPayloadReader;
import com.google.android.dgenexo.extractor.wav.WavExtractor;
  ...
  static {
    ...
    try {
      ...
      boolean isFlacNativeLibraryAvailable =
          Boolean.TRUE.equals(
              Class.forName("com.google.android.dgenexo.ext.flac.FlacLibrary")
                  .getMethod("isAvailable")
                  .invoke(/* obj= */ null));
      if (isFlacNativeLibraryAvailable) {
        flacExtensionExtractorConstructor =
            Class.forName("com.google.android.dgenexo.ext.flac.FlacExtractor")
